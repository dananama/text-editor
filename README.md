Customizable React poll application written with ShiftJS. This application provides a frontend view for the poll, and backend logic to track votes persistently for users. 
